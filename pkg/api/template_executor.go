...
func ProvisioningOpenstackCluster(worker *job.IWorker, cluster *model.OpenstackClusterTable, nodeSets []*model.NodeSetTable, k8sVersion string) error {
	// // Make provision data
	...
	job.InvokeProvisionCheck(worker, *cluster.ClusterUid, *cluster.Name, *cluster.Namespace)
